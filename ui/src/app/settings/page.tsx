...
export default function SettingsPage() {
	...
	const showDialog = !loading && !accountId && !account
	...
	return (
		<>
			<AccountDialog open={showDialog} onCreate={create} onJoin={join} />
			{!showDialog && account && (
				<div className="mx-auto flex min-h-screen max-w-lg flex-col gap-6 p-6">
					...
					<section className="rounded border p-4">
						...
						<p className="mb-2 text-xs text-zinc-500">Share this ID to sync across devices:</p>
