...
// .wrangler/tmp/bundle-is1ooQ/strip-cf-connecting-ip-header.js
...
var ProgressDO = /* @__PURE__ */ __name(class extends DurableObject {
  ...
  handleState() {
    ...
    const activeProgress = this.account.activeEpisodeId ? this.progress.get(this.account.activeEpisodeId) : null;
    return new Response(
      JSON.stringify({
        account: {
...
// .wrangler/tmp/bundle-is1ooQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-is1ooQ/middleware-loader.entry.ts
