...
// .wrangler/tmp/bundle-GaVwPr/strip-cf-connecting-ip-header.js
...
var ProgressDO = /* @__PURE__ */ __name(class extends DurableObject {
  account = null;
      ...
      if (row) {
        ...
        for (const p of progressRows.results || []) {
          this.progress.set(p.episode_id, {
            ...
            durationSec: p.duration_sec ?? void 0,
            state: p.state,
    ...
    return new Response(
      JSON.stringify({
        account: this.account ? {
          ...
          positionSec: this.account.activeEpisodeId ? this.progress.get(this.account.activeEpisodeId)?.positionSec || 0 : 0,
  ...
  async handleProgress(req) {
    const body = await req.json();
    const now = Date.now();
    const LEASE_DURATION = 5 * 60 * 1e3;
...
// node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260502.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260502.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-GaVwPr/middleware-insertion-facade.js
...
// node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260502.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-GaVwPr/middleware-loader.entry.ts
